...
const allSuggestions = ["CBERS4A", "Landsat-8", "CBERS-2B", "GOES-19", "Sentinel-2", "MODIS Terra/Aqua", "Landsat series", "MODIS Aqua", "Sentinel-3 OLCI", "CBERS-4", "Estações meteorológicas / satélite", "CBERS WFI"];
